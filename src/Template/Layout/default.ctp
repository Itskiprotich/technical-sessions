...
<head>
    ...
    <?= $this->Html->css('icons/icomoon/styles.min.css') ?>
    <!-- Reference JS Files -->
    <?= $this->Html->script('app.js') ?>
    <?= $this->Html->script('custom.js') ?>

    <!-- Point Those Files under global_assets -->
    <?= $this->Html->script('main/jquery.min.js') ?>
    <?= $this->Html->script('main/bootstrap.bundle.min.js') ?>
    ...
    <div class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="navbar-collapse collapse" id="navbar-footer">
            <span class="navbar-text">
                &copy; 2018- <?php echo date('Y');?>. <a href="#">Technical Working Session</a> by <a href="https://github.com/Itskiprotich/technical-sessions" target="_blank">Kiprotich Japheth</a>
            </span>
